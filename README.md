...
| 技能 | 什么时候用 | 你会得到 |
| --- | --- | --- |
| [learn-start](./skills/learn-start/SKILL.md) | 完全不知道从哪开始 | 判断你在哪一步，直接接到对的技能 |
| [mentor-grill](./skills/mentor-grill/SKILL.md) | 想法还很模糊 | 一轮一问、每问带选项的需求澄清，最后落一份需求共识 |
| [learn-roadmap](./skills/learn-roadmap/SKILL.md) | 需求清楚，不知道先做哪个 | 一份每步做完都能看见成果的白话路线图 |
| [learn-tdd](./skills/learn-tdd/SKILL.md) | 要动手写功能 | AI 写好失败的测试并留空位，你填核心代码 |
| [learn-refactor](./skills/learn-refactor/SKILL.md) | 代码写完想改好 | 一次只指一条坏味道，讲透原理，你动手改 |
| [jargon-buster](./skills/jargon-buster/SKILL.md) | 有词听不懂 | 一句话白话加生活类比，外加一份[常见术语表](./skills/jargon-buster/glossary.md) |
...
「我想做个记账的小工具」
   ...
   .learn/路线图.md
        ↓  learn-tdd：第 1 步，AI 写测试你填代码，红 → 绿 → 重构
     能跑的功能
